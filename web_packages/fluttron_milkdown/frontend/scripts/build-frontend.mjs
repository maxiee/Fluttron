...
const sourceFile = path.join(packageRoot, 'frontend', 'src', 'main.js');
const outputFile = path.join(packageRoot, 'web', 'ext', 'main.js');
const outputCssFile = path.join(packageRoot, 'web', 'ext', 'main.css');

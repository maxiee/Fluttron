...
**当前状态：Phase A 已全部完成（v0075-v0079），v0080-v0102 已完成，Phase E 已开始，当前入口版本为 v0103**
...
- **当前入口**：`v0103`（Smoke Test 脚本创建与执行）
- **技术方案参阅**：`docs/feature/v1_release_roadmap.md §v0103`
- **最小验收**：`scripts/smoke_test.sh` 无人工干预端到端全通过
- 已完成的重大能力：

...
**当前状态：Phase A 已全部完成（v0075-v0079），v0080-v0093 已完成，当前入口版本为 v0094**
...
- **当前入口**：`v0094`（仓库清理，更新 `.gitignore`）
- **技术方案参阅**：`docs/feature/v1_release_roadmap.md §v0094`
- **最小验收**：`.gitignore` 覆盖所有开发工具目录；仓库根目录对外部访客整洁
- 已完成的重大能力：

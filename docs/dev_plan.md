...
**当前状态：Phase A 已全部完成（v0075-v0079），v0080-v0089 已完成，当前入口版本为 v0090**
...
- **当前入口**：`v0090`（创建 GitHub Issue/PR 模板）
- **技术方案参阅**：`docs/feature/v1_release_roadmap.md §v0090`
- **最小验收**：3 个模板文件存在；YAML frontmatter 正确；PR 模板含 analyze/test/docs checklist
- 已完成的重大能力：

...
**当前状态：Phase A 进行中，v0075 已完成，当前入口版本为 v0076**
...
- **当前入口**：`v0076`（统一所有包 pubspec 元数据，版本号设为 `0.1.0-dev`）
- **技术方案参阅**：`docs/feature/v1_release_roadmap.md §v0076`（`### v0076 — Standardize package versions and metadata`）
- **最小验收**：5 个 pubspec 描述有意义；版本均为 `0.1.0-dev`；`dart pub get` 全部成功；无新 analyze 问题
- 已完成的重大能力：

...
**当前状态：Phase A 已全部完成（v0075-v0079），v0080-v0084 已完成，当前入口版本为 v0085**
...
- **当前入口**：`v0085`（全局错误边界：host + UI）
- **技术方案参阅**：`docs/feature/v1_release_roadmap.md §v0085`
- **最小验收**：未捕获错误有 stack trace 日志输出；Bridge 错误有有意义提示；模板包含错误边界
- 已完成的重大能力：
